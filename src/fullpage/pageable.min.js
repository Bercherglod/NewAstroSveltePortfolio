...
Element.prototype.matches ||
	...
	(function (a, b) {
		...
		function () {
			...
			var g = function (c, e) {
				if (void 0 === c) return console.error('Pageable:', 'No container defined.')
				var f = this
				...
				!this.container)
					...
					: ((this.config = d(
					  ...
					  this.pages.length
							? void ((this.horizontal = 'horizontal' === this.config.orientation),
							  (this.anchors = []),
			...
			return (
				...
				(g.prototype.bind = function () {
					;(this.callbacks = {
						...
						this.navPrevEl &&
							(this.navPrevEl.addEventListener('click', this.callbacks.prev, !1),
							this.navNextEl &&
								this.navNextEl.addEventListener('click', this.callbacks.next, !1)),
				...
				(g.prototype.unbind = function () {
					this.wrapper.removeEventListener('wheel', this.callbacks.wheel),
						...
						this.navPrevEl &&
							this.navPrevEl.removeEventListener('click', this.callbacks.prev, !1),
						this.navNextEl &&
							this.navNextEl.removeEventListener('click', this.callbacks.next, !1),
				...
				(g.prototype.next = function () {
					if (this.config.infinite) {
						var a = this.index
						if (a === this.lastIndex)
							return a++, this._scrollBy(-this.data.window[this.size[this.axis]], a)
					}
				...
				(g.prototype.destroy = function () {
					if (this.initialised) {
						...
						;['Prev', 'Next'].forEach(function (a) {
							var b = 'nav' + a + 'El'
							this[b] &&
								(this[b].classList.remove('active'), this[b].classList.remove('pg-nav'))
						}, this),
				...
				(g.prototype.emit = function (a) {
					if (((this.listeners = this.listeners || {}), !1 != a in this.listeners))
				...
				(g.prototype._start = function (a) {
					...
					return (
						...
						('touchstart' !== a.type || this.events.touch
							? !!('mousedown' !== a.type || (this.events.mouse && 0 === a.button)) &&
				...
				(g.prototype._stop = function (a) {
					...
					if (
						...
						return (
							(this.dragging = h),
							g &&
								(this.config.infinite && this._overScroll(0 > h, h), 0 < h ? e() : d()),
					...
					if (this.down && !this.scrolling) {
						...
						g && (this.config.infinite && this._overScroll(i), i ? d() : j && e()),
							this.startIndex === this.index
				...
				(g.prototype._getData = function () {
					var a = this.config.infinite
						...
						b = this.config.infinite
							...
							: this.scrollSize
					return { index: this.index, percent: 100 * (a / b), scrolled: a, max: b }
				}),
				(g.prototype._overScroll = function (a) {
					var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
						c = this.index
					c === this.lastIndex && a
						? (c++, this._scrollBy(-this.data.window[this.size[this.axis]] - b, c))
						: 0 === c &&
						  !a &&
						  (c--, this._scrollBy(this.data.window[this.size[this.axis]] - b, c))
				}),
