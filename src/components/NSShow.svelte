...
<div class="w-[100vw] h-[60vh] xm:h-[100vh]">
	<Swiper
		...
		<SwiperSlide>
			...
			<div class=" bg-[url('/other/3d/rotunda_01.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/3d/cupboard_01.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/3d/cupboard_m_01.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/3d/cupboard_02.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/3d/kalinina.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class="">
				<h1
					class="w-full text-base xm:text-4xl sm:text-4xl text-center font-bold text-white">
			...
			<div class=" bg-[url('/other/3d/sber_02.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div
				class=" col-span-2 bg-[url('/other/3d/rotunda_02.webp')] bg-cover bg-bottom" />
		</SwiperSlide><SwiperSlide>
			<div
				class=" col-span-2 bg-[url('/other/3d/sunfill.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/03.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/01.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/04.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/05.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/06.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/07.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class="">
				<h1
					class="w-full text-base xm:text-4xl sm:text-4xl text-center font-bold text-white">
			...
			<div class=" bg-[url('/other/other/10.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/09.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/11.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/02.webp')] bg-cover bg-center" />
		</SwiperSlide><SwiperSlide>
			<div class=" bg-[url('/other/other/12.webp')] bg-cover bg-center" />
		</SwiperSlide>
	</Swiper>
</div>
